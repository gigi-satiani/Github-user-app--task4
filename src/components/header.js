      ...
      <div className="searchParent">
        <div className="searchInputParent">
          <figure className="figureParent">
            <img src={mySearch} className="searchIcon" />
          </figure>
          <input
            type="search"
            ...
            <ErrorMessage style={{color: '#F74646', fontFamily: "monospace", fontSize: '15px',
             paddingRight: '5px', display: 'flex', alignItems: 'center'}}>{props.data.message && 'No results'}</ErrorMessage>
        </div>
